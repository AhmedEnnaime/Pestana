<footer class="footer">
    ...
    <div class="foot-section2">
        ...
        <div class="foot-info">
            <div class="foot-info-box">
                ...
                <div class="foot-location">
                    ...
                    <p class="foot-location-info">24 Hilton Av. Maitama, Abuja</p>
                    </li>
                </div>
                ...
                <div class="foot-social">
                    <div class="social__icons fb">
                        <img src="<?php echo URLROOT; ?>/assets/images/client_img/fb.jpg" alt="Facebook icon">
                    </div>
                    <div class="social__icons tw">
                        <img src="<?php echo URLROOT; ?>/assets/images/client_img/tw.jpg" alt="Twitter icon">
                    </div>
                    <div class="social__icons ins">
                        <img src="<?php echo URLROOT; ?>/assets/images/client_img/ins.jpg" alt="Instagram icon">
                    </div>
                </div>
            </div>
        ...
        <div class="foot-last">
            ...
            <p>Copyright 2020 Pestana hotel</p>
